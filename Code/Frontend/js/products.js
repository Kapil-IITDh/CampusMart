          ...
          productBlock.innerHTML = `
              <div class="border">
                  <div class="productImage">
                      <img src="${imageURLs[0] || 'https://images.unsplash.com/photo-1484788984921-03950022c9ef?q=80&w=1232&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}" alt="${title}" width="180" height="180">
                  </div>
